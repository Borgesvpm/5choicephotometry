...
% tev_path = [filepath filesep tank filesep blk filesep '*.tev']
% pause
% tsq_path = [filepath filesep tank filesep blk filesep '*.tsq']
% pause
% 
% tev_path = uigetfile('*.tev');
% tsq_path = uigetfile('*.tsq');
